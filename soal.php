            ...
            <div class='box-body'>
                <div class='row'>
                    <div class='col-md-12'>
                        ...
                        <div class='col-md-12 scrollsoal'>
                            <?php
                            if ($soal['file'] <> '') {
                                ...
                                if (in_array($ext, $image)) {
                                    ...
                                    echo "<span  style='display:inline-block'> <img  src='$homeurl/files/$soal[file]' class='img-fluid max-width: 100%;'/></span><br>";
                            ...
                            if ($soal['file1'] <> '') {
                                ...
                                if (in_array($ext, $image)) {
                                    ...
                                    echo "<span  style='display:inline-block'> <img  src='$homeurl/files/$soal[file1]' class='img-fluid max-width: 100%;'/></span>";
                                } elseif (in_array($ext, $audio)) {
