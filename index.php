...
<body class='hold-transition skin-green-light  fixed <?= $sidebar ?>'>
                            ...
                            <ul class='dropdown-menu'>
                                ...
                                <li class='user-footer'>
                                    <div class='pull-right'>
                                        <!--<a href='<?= $homeurl ?>/logout.php' class='btn btn-sm btn-default btn-flat'><i class='fas fa-sign-out-alt'></i> Keluar</a>-->
                                    </div>
                                </li>
                            </ul>
                        </li>
            ...
            <section class='sidebar'>
                ...
                <div class='user-panel'>
                    ...
                    <div class='pull-left info' style='left:65px'>
                        ...
                        <p><span class="badge bg-red"><?=$siswa['idpk']?></span> <span class="badge bg-green"><?=$siswa['id_kelas']?></span> <span class="badge bg-purple">Sesi-<?=$siswa['sesi']?></span></p>
                    </div>
                ...
                <ul class='sidebar-menu tree' data-widget='tree'>
                    ...
                    <li><a href='<?= $homeurl ?>/hasil'><i class='fas fa-paste  '></i> <span> Hasil Ujian</span></a></li>
                    <li><a href='<?= $homeurl ?>/logout.php'><i class="fas fa-sign-out-alt fa-1x"></i> Keluar</a></li>
                    <li>
                                                            ...
                                                            if ($nilai['ujian_mulai'] <> '' and $nilai['ujian_berlangsung'] <> '' and $nilai['ujian_selesai'] <> '') {
                                                                ...
                                                                $btntest = "<button class='btn btn-block btn-success btn-sm disabled'> Sudah Ujian</button>";
                                                                    ...
                                                                    if($nilai['skor']>=$mapelx['kkm']){
                                                                        ...
                                                                        $btntest = "<button data-id='".$nilai['id_nilai']."' class='btn btn-ulang btn-warning btn-block btn-sm '>Belum Lulus - Skor : ".$nilai['skor']."<br>(Klik untuk remidi)</button>";   
                                                                    }
                                                                }
                                                            } else {
    ...
    <?php if ($pg == 'testongoing') : ?>
        ...
        swal({
            ...
            html: 'Saya <strong><?= $siswa['nama'] ?> </strong> akan mengerjakan soal dengan sunguh-sungguh dan tidak menyontek <br> ataupun merekam/membagikan soal dalam bentuk apapun kepada siapapun tanpa izin pihak Madrasah',
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.btn-belum', function() {
                    ...
                    swal({
                        ...
                        imageUrl: 'https://media.giphy.com/media/Wn0qt9qJ0ubJL8tAZ8/giphy.gif',
                                      imageWidth: 275,
                                      imageHeight: 275,
