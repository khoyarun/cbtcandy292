                        ...
                        <tbody>
                            ...
                            <?php while ($data = mysqli_fetch_array($siswa)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($data['hp'] <> "") { ?>
                                            <a target="_blank" href="https://api.whatsapp.com/send?phone=+62<?= $data['hp'] ?>&text=Assalamualaikum+<?= $data['nama'] ?>%0D%0A..pesan" role="button"><i class="fab fa-2x fa-whatsapp text-green   "></i> <?= $data['hp'] ?></a>
                                        <?php } ?>
                                    </td>
                                    <td>
