                                ...
                                <tbody>
                                    ...
                                    <?php while ($data = mysqli_fetch_array($mapel)) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (!$nilai) { ?>
                                                    <a target="_blank" href="https://api.whatsapp.com/send?phone=+62<?= $data['hp'] ?>&text=<?= $data['nama'] ?>%20kamu%20belum%20ujian%20<?= $ujian['kode'] ?>.%20Ayo Segera Kerjakan." role="button"><i class="fab fa-2x fa-whatsapp text-green   "></i> <?= $data['hp'] ?></a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
