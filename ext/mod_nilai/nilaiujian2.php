            ...
            <div class='box box-solid'>
                <div class='box-header with-border'>
                    ...
                    <div class='box-tools pull-right btn-grou'>
                        ...
                        <a class='btn btn-sm btn-success' href='mod_nilai/report_excel.php?m=<?= $id_mapel ?>&k=<?= $id_kelas ?>'><i class='fa fa-download'></i> Download Analisis</a>
                        <a class='btn btn-sm btn-primary' href='mod_nilai/report_excel_skor.php?m=<?= $id_mapel ?>&k=<?= $id_kelas ?>'><i class='fa fa-download'></i> Download Skor</a>
