...
($id_pengawas == 0) ? header('location:login2.php') : null;
...
<body class='hold-transition skin-green-light fixed <?= $sidebar ?>'>
	...
	<div class='wrapper'>
		<header class='main-header'>
			<a href='?' class='logo' style='background-color:#1E90FF'>
					...
					<?php if ($pengawas['level'] == 'admin') : ?>
						...
						<li class='treeview'>
							...
							<ul class='treeview-menu'>
								...
								<li><a href='?pg=aktifasi'><i class='fas fa-angle-double-right fa-fw'></i> <span>Aktifasi Semua</span></a></li>
							</ul>
						</li>
