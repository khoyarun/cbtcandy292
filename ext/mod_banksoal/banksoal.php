                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <?php if ($setting['server'] == 'pusat') : ?>
                                                        ...
                                                        <div class=''>
                                                            ...
                                                            <?php 
                                                              $id_cetak = $mapel["id_mapel"];
                                                             ?>
                                                            <button class='btn btn-sm btn-flat btn-info' onclick="frames['frameresult<?=$id_cetak?>'].print()"><i class='fa fa-print'></i><span class='hidden-xs'> Print</span> <label class="label label-danger" >Fitur Baru!!</label></button>
                                                            <iframe name='frameresult<?=$id_cetak?>' src='mod_banksoal/cetaksoal.php?id=<?= $id_cetak ?>' style='border:none;width:1px;height:1px;'></iframe> 
                                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    Format : Nama-mapel_kelas_ket<br>
                                    Ex 
                                    <span class="label label-info">Bhs-Indo_10</span>
                                    <span class="label label-danger">Matematika_11_PM</span>
                                    <span class="label label-success">Fisika_12_LM</span>
