    ...
    if ($token <> '' and $data <> '') {
        ...
        Silahkan periksa koneksi internet dan token
            ...
            if ($data == 'soal') {
                ...
                if ($sync <> null) {
                    $sql = mysqli_query($koneksi, "truncate table file_pendukung");
                    ...
                    $exec = mysqli_query($koneksi, "update sinkron set jumlah='$masuk5', status_sinkron='1',tanggal='$datetime' where nama_data='DATA5'");
